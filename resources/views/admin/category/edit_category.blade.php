...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <form action="{{ URL::to('update-category/'.$category->category_id) }}" method="POST" id="form_category_create"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="add-image-file">
                                <div class="mb-3">
                                    ...
                                    <img width = "70px" src="{{ asset ('uploads/category/'.$category->category_images) }}"> 
                                </div>
