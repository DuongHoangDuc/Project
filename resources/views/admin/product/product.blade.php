    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                ...
                <div class="card">
                    <div class="mb-3">
                    <a href="{{ URL::to ('/add-product') }}" class="btn btn-primary">Thêm sản phẩm</a>
                                    ...
                                    <table id="datatable" class="table table-bordered table-nowrap mb-0 dataTable no-footer"
                                        ...
                                        <tbody id="render_product">
                                            <tr id="product_table_128" role="row" class="odd">
                                                <td class="sorting_1"><input type="checkbox" class="sub_chk"
                                                        name="data_ids" data-id="128"></td>
                                               
                                                <td>{{ $pro->product_name }}</td>
                                                 <td><img src="{{ asset ('uploads/products/'.$pro->product_images) }}" width="100" height="100" alt="" style="border-radius: 1.8rem"></td>
                                                <td>{{number_format($pro->product_price,0,',','.')  }}</td>
                                                <td>
                                                <?php
                                                if(  $pro->product_hot == 0){
                                                 ?>
                                                 <a href = ""  class="btn btn-light">none</a>
                                                 <?php }else{ ?>
                                                  <a href = ""  class="btn btn-danger">Hot</a>
                                                 <?php } ?>
                                                </td>
